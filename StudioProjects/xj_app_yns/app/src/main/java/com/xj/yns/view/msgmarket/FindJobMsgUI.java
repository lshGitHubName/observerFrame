 ...
 */
public class FindJobMsgUI extends BaseUI {

    public FindJobMsgUI(Context context, Bundle bundle) {
    ...
    @Override
    public int getID() {
        return ConstantValue.VIEW_MSGMARKET_FIND_JOB;
    }
}
