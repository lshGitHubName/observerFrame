 ...
 */
public class SeekBuyerMsgUI extends BaseUI {

    public SeekBuyerMsgUI(Context context, Bundle bundle) {
    ...
    @Override
    public int getID() {
        return ConstantValue.VIEW_MSGMARKET_SEEK_BUYER;
    }
}
