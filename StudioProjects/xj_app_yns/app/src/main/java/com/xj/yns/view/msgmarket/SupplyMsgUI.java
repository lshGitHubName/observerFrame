 ...
 */
public class SupplyMsgUI extends BaseUI {

    public SupplyMsgUI(Context context, Bundle bundle) {
    ...
    @Override
    public int getID() {
        return ConstantValue.VIEW_MSGMARKET_SUPPLY;
    }
}
